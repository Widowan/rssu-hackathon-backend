...
@Repository
public class OldGameResultRepository {
    ...
    private final RowMapper<OldGameTotalResult> totalResultRowMapper;
    private final static Logger log = LoggerFactory.getLogger(OldGameResultRepository.class);
    ...
    public OldGameTotalResult findGameTotalResultForDays(int userId, int gameId, int days) {
        var sql = """
                WITH DatesTable AS (
                    SELECT
                        user_id,
    ...
    public OldGameResultRepository(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
        ...
        this.leaderboardRowRowMapper = (rs, rowNum) -> ImmutableLeaderboardRow.builder()
                ...
                .build();
        this.totalResultRowMapper = (rs, rowNum) -> ImmutableOldGameTotalResult.builder()
                .userId(rs.getInt("user_id"))
                .gameId(rs.getInt("game_id"))
                .sumScore(rs.getInt("sum_score"))
                .build();
